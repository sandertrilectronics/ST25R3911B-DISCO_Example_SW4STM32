                               ...
                               uint8_t cfgidx)
{
  ...
  else
  {
    ...
    hhid->InState = CUSTOM_HID_IDLE;
    hhid->OutState = CUSTOM_HID_IDLE;
                                 ...
                                 uint16_t len)
{
  ...
  {
    if(hhid->InState == CUSTOM_HID_IDLE)
    {
      hhid->InState = CUSTOM_HID_BUSY;
                              ...
                              uint8_t epnum)
{
  ...
  ((USBD_CUSTOM_HID_HandleTypeDef *)pdev->pClassData)->InState = CUSTOM_HID_IDLE;
...
static uint8_t  USBD_CUSTOM_HID_DataOut (USBD_HandleTypeDef *pdev, uint8_t epnum)
{
  ...
  if(hhid->OutState == CUSTOM_HID_IDLE)
  {
    hhid->OutState = CUSTOM_HID_BUSY;
