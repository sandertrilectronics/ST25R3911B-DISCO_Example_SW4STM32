...
#define RFAL_NFCV_FDT_V_INVENT_NORES      4
...
/*******************************************************************************/
ReturnCode rfalNfcvPollerSleep( uint8_t flags, uint8_t* uid )
{
    ReturnCode      ret;
...
/*******************************************************************************/
ReturnCode rfalNfcvPollerSelect( uint8_t flags, uint8_t* uid )
{
    uint16_t           rcvLen;
    ReturnCode         ret;
...
/*******************************************************************************/
ReturnCode rfalNfcvPollerReadSingleBlock( uint8_t flags, uint8_t* uid, uint8_t blockNum, uint8_t* rxBuf, uint16_t rxBufLen, uint16_t *rcvLen )
{
    ReturnCode         ret;
    rfalNfcvGenericReq req;
    rfalNfcvGenericRes *res;
...
/*******************************************************************************/
ReturnCode rfalNfcvPollerWriteSingleBlock( uint8_t flags, uint8_t* uid, uint8_t blockNum, uint8_t* wrData, uint8_t blockLen )
{
    ReturnCode         ret;
    uint16_t           rcvLen;
    rfalNfcvGenericReq req;
...
/*******************************************************************************/
ReturnCode rfalNfcvPollerReadMultipleBlocks( uint8_t flags, uint8_t* uid, uint8_t firstBlockNum, uint8_t numOfBlocks, uint8_t* rxBuf, uint16_t rxBufLen, uint16_t *rcvLen )
{
    ReturnCode          ret;
    rfalNfcvGenericReq  req;
    rfalNfcvGenericRes  *res;
