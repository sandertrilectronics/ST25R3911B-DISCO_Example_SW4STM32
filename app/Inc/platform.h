...
******************************************************************************
*/
//#define platformIrqST25R3911Disable()                 HAL_NVIC_DisableIRQ(EXTI0_IRQn);              /*!< Disables ST353911 MCU's external interrupt  */
//#define platformIrqST25R3911Enable()                  HAL_NVIC_EnableIRQ(EXTI0_IRQn);               /*!< Enables ST353911 MCU's external interrupt   */
#define platformProtectST25R391xIrqStatus()           HAL_NVIC_DisableIRQ(EXTI0_IRQn);              /*!< Disables ST353911 MCU's external interrupt  */
#define platformUnprotectST25R391xIrqStatus()         HAL_NVIC_EnableIRQ(EXTI0_IRQn);               /*!< Enables ST353911 MCU's external interrupt   */
